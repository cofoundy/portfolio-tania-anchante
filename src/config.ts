export const siteConfig = {
  ...
  projects: [
    {
      name: "UNMSM English Volunteer Program",
      description:
        "Co-founded an English teaching volunteer program at Universidad Nacional Mayor de San Marcos, providing free English instruction to young adults for over 5 years (2019–2024).",
      link: "",
      skills: ["Teaching", "Leadership", "Community Impact"],
    },
    {
      name: "APEC 2024 — Bilingual Translator",
      description:
        "Served as bilingual translator for the APEC 2024 Senior Officials' Meetings and Ministerial Events in Lima, Peru.",
      link: "",
      skills: ["Translation", "Diplomacy", "Bilingual Communication"],
    },
    {
      name: "REDMUN — Regional Deputy Director",
      description:
        "Metropolitan Lima Regional Deputy Director at REDMUN (Red Mundial de Jóvenes Políticos). Managed regional initiatives, coordinated national projects, and oversaw internal communications.",
      link: "",
      skills: ["Leadership", "Project Management", "Communications"],
    },
  ],
  experience: [
    {
      ...
      bullets: [
        ...
        "Offer pedagogical guidance tailored to different teaching contexts and learner needs",
      ],
    },
    {
    ...
    },
    {
      ...
      bullets: [
        ...
        "Mentored teachers in creating classroom activities",
      ],
    },
  ],
  education: [
    {
      ...
      dateRange: "",
      achievements: [
        "Specialized in language teaching pedagogy",
      ],
    },
    {
    ...
    {
      school: "Aspire Institute (Harvard University)",
      degree: "Aspire Leaders Program",
      dateRange: "",
      achievements: [
        "Selective program with applicants from 100+ countries",
        "Supported by HarvardX coursework and Harvard University faculty",
      ],
    },
  ],
};
